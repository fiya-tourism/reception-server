    ...
    <div class="cw1200">
		<div class="w810 fl">
			...
			<div class="public_box bg1">
				...
				<div id="list_sort">
					<ul>
						<li><span>产品类型：</span><a href="scenic_list.html">旅游景区</a><a class="cur" href="activities_list.html">旅游活动</a><div class="clear"></div></li>
					</ul>
				</div>
				<!------------------活动列表-------------------->
				<div id="activities_list">
					<ul>
						<li>
							<div class="pic"><a href="activities.html"><img class="scale-effect" src="images/y1.jpg"/></a></div>
							<div class="con">
